...
skeletonim = imread('person_skeleton6.jpg'); 
...
% person 불러오기
person = imread('person_black6.bmp');
...
for joint=1:6
   if joint==1 %머리-어깨중심
    ...
    elseif joint==2 %어깨중심-가랑이
        ...
        x0=[-10, -10, -5, 10, getGlobalHeadX, getGlobalHeadY];
        setGlobalCount(2);
    elseif joint==3 %어깨중심-왼쪽손
        x0 = [getGlobalSpinShoulderBaseX, getGlobalSpinShoulderBaseY, getGlobalSpinShoulderBaseX-30, getGlobalSpinShoulderBaseY-3];
        %x0 = [-10, -15, -20, -13];
        setGlobalCount(3);
    ...
    elseif joint==5 %가랑이-왼쪽발
        x0 = [getGlobalSpinBaseX, getGlobalSpinBaseY, getGlobalSpinBaseX-20, getGlobalSpinBaseY+25];
        %x0 = [-10, 10, -12, 20];
        setGlobalCount(5);
