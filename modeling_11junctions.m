...
firstim = imread('person_skeleton6.jpg'); 
...
% skeleton ºÒ·¯¿À±â
skeleton = imread('person_black6.bmp');
...
% subplot(2,3,1); imagesc(firstimage);colormap('gray');drawnow; %ÀÌ¹ÌÁö ±×¸®±â
...
subplot(2,2,1); imagesc(skeleton_blur);colormap('gray');drawnow; %ÀÌ¹ÌÁö ±×¸®±â
wpath  = sprintf('tmp_img');
im0=skeleton_blur;
save(wpath,'im0');
...
for joint=1:10
   if joint==1 %¸Ó¸®-¾î±úÁß½É
    ...
    elseif joint==3 %¾î±úÁß½É-¿ÞÂÊÆÈ²ÞÄ¡
        x0 = [getGlobalSpinShoulderBaseX, getGlobalSpinShoulderBaseY, getGlobalSpinShoulderBaseX-15, getGlobalSpinShoulderBaseY, 5];
        %x0 = [-10, -15, -20, -13];
        setGlobalCount(3);
    ...
    elseif joint==7 %¿ÞÂÊÆÈ²ÞÄ¡-¿ÞÂÊ¼Õ
        x0 = [getGlobalLeftElbowX, getGlobalLeftElbowY, getGlobalLeftElbowX-15, getGlobalLeftElbowY, 5];
        setGlobalCount(7);
    elseif joint==8 %¿À¸¥ÂÊÆÈ²ÞÄ¡-¿À¸¥ÂÊ¼Õ
        x0 = [getGlobalRightElbowX, getGlobalRightElbowY, getGlobalRightElbowX+15, getGlobalRightElbowY, 5];
        setGlobalCount(8);
